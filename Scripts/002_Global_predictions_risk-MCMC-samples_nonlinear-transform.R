...
#import prediction data set (pressure values aggregated at 100km) and transform to Molleweide projection
...
#match names with names in data model 
...
# repeat a single life-history but this does not affect predictions as there is no interaction with life history and predictors in the final model  
prediction_data$lh <- rep(as.factor("P"))
